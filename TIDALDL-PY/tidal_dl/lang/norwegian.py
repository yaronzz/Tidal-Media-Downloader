...
class LangNorwegian(object):
    ...
    SETTING_CREATE_ALBUM_FOLDER_FOR_SINGLE_DOWNLOAD = "Opprett albummappe for nedlasting av enkeltfil"
    ...
    CHANGE_CREATE_ALBUM_FOLDER_FOR_SINGLE_DOWNLOAD = "Opprett albummappe for nedlasting av enkeltfil('0'-No,'1'-Yes):"
