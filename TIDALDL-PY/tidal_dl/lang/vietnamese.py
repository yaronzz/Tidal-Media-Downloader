...
class LangVietnamese(object):
    ...
    SETTING_CHECK_ALBUM_EXIST = "Kiểm tra xem album có tồn tại không"
    ...
    CHANGE_CHECK_ALBUM_EXIST = "Kiểm tra xem album có tồn tại hay không trước khi tải xuống('0'-No,'1'-Yes):" 
