...
class LangNorwegian(object):
    ...
    SETTING_CREATE_FOLDER_FOR_SINGLE_DOWNLOAD = "Opprett mappe for nedlasting av enkeltfil"
    ...
    CHANGE_CREATE_FOLDER_FOR_SINGLE_DOWNLOAD = "Create folder for single download"
