...
class LangTurkish(object):
    ...
    SETTING_CHECK_ALBUM_EXIST = "Albümün var olup olmadığını kontrol edin"
    ...
    CHANGE_CHECK_ALBUM_EXIST = "İndirmeden önce albümün var olup olmadığını kontrol edin('0'-No,'1'-Yes):"
