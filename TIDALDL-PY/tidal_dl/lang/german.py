...
class LangGerman(object):
    ...
    SETTING_CHECK_ALBUM_EXIST = "Überprüfen Sie, ob das Album existiert"
    ...
    CHANGE_CHECK_ALBUM_EXIST = "Überprüfen Sie vor dem Herunterladen, ob das Album existiert('0'-No,'1'-Yes):"
