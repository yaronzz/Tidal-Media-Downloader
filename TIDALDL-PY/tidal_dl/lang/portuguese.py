...
class LangPortuguese(object):
    ...
    SETTING_CREATE_ALBUM_FOLDER_FOR_SINGLE_DOWNLOAD = "Create album folder for single downloads"
    ...
    CHANGE_CREATE_ALBUM_FOLDER_FOR_SINGLE_DOWNLOAD = "Create albumfolder for single download('0'-No,'1'-Yes):"
